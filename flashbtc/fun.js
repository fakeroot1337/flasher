...
telegram.onclick = ()=> {
  ...
  navShowHelp.style.display = "none"
  notificationHeadP.textContent = "Flash BTC"
  notificationBodyP.textContent = "https://t.me/systemadminbdbot"
}
...
email.onclick = ()=> {
  ...
  navShowHelp.style.display = "none"
  notificationHeadP.textContent = "Flash BTC"
  notificationBodyP.textContent = "Email: admin@systemadminb.com"
}
...
activateSoftwareBtn.onclick = ()=> {
  ...
  } else if(activationInput.value == "sysmadofficial.fuckyou") {
...
function onloadFun() {
  ...
  let arr = ["[INFO] Flash BTC Transaction (Core Network)", "[INFO] Copyright (C) Flashbtc.rf.gd | JULY 2022. Telegram: https://t.me/systemadminbdbot", "[INFO] Running on", "[INFO] Blockchain network loading..."]
  let k = 0
  function onloadShow() {
